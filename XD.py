...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/BLACK-505/XD/blob/main/approval.txt').text#apnar Github Approved Link diben Akhne Ok
    if id in httpCaht:
      ...
      print(f"{G} 7day 50Tk 30day 150Tk");linex()
      input(f'{G}[=] CLICK ENTER TO SENT KEY ADMIN FB ')
      os.system("xdg-open https://www.facebook.com/md.eabrahim.miah.999?")
      exit()
  except:
    sys.exit()
#________________| LOGO |________________#
logo=(f"""{G}
     {G1}____ ___  ____ ____ _  _ _ _  _    
     {Y}|___ |__] |__/ |__| |__| | |\/|    
     {S}|___ |__] |  \ |  | |  | | |  |   
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[=] FACEBOOK  : MD EBRAHIM MIAH
{G1}[=] TOOLS  : FILE X RANDM CLONING
{G1}[=] VERSION : 0.1 
{G1}[=] STATUS : PARSONAL 
{M}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def menu():
       clear()
       print(f"{G1}[1] FILE CLONING")
       print(f"{G1}[2] RANDOM CLONING")
       print(f"{G1}[0] EXIT CLONING");linex()
       choice=input(f"{G1}[?] CHOICE : ")
